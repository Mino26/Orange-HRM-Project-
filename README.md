...
<h3>The scope of the final project 3</h3> for ITF Manual Testing Course is to use all gained knowledge throught the course and apply them in practice, using a live application.
